...
<h1>Termos de Uso</h1>
<div class="container">
     <h1>TERMOS E CONDIÇÕES DE USO – ECOTIRE</h1>
  <p><strong>Última atualização:</strong> 06 de fevereiro de 2026</p>

  <p>
    Este documento estabelece os Termos e Condições de Uso do site da Ecotire. 
  ...
  <h2>1. SOBRE A ECOTIRE</h2>
  <p>
    A Ecotire é uma marca voltada à produção e comercialização de estojos sustentáveis 
  ...
  <ul>
    ...
    <li>Respeitar os direitos da Ecotire e de terceiros.</li>
  </ul>

  <h2>4. PRODUTOS</h2>
  <p>
    Os produtos comercializados pela Ecotire são confeccionados com materiais reciclados, 
  ...
  <p>
    A Ecotire reserva-se o direito de cancelar pedidos em caso de suspeita 
  ...
  <p>
    A Ecotire não se responsabiliza por atrasos decorrentes de fatores externos, 
  ...
  <p>
    Em caso de defeito de fabricação ou envio incorreto, a Ecotire providenciará 
  ...
  <p>
    ...
    layout, design e demais elementos, é de propriedade exclusiva da Ecotire 
  ...
  <p>
    A Ecotire não se responsabiliza por danos decorrentes do uso indevido do site, 
  ...
  <p>
    A Ecotire poderá modificar estes Termos e Condições de Uso a qualquer momento, 
  ...
  <p>
    ...
    <a href="mailto:ecotire@gmail.com">ecotire@gmail.com</a>
  </p>
</div>
</main>
<footer>
